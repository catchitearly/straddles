...
<body>
        ...
        <div class="speed-table-wrap">
            <table id="speedTable">
                ...
                <tbody id="speedTableBody">
                    <tr><td colspan="9" style="text-align:center;color:{MUTED};padding:30px;">
    ...
    function updateTable() {{
        ...
        if (rows.length === 0) {{
            tbody.innerHTML = '<tr><td colspan="9" style="text-align:center;color:{MUTED};padding:30px;">No data available for selected window</td></tr>';
        }} else {{
