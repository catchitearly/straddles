...
def fetch_and_enrich_strike(fyers, strike, spot_df):
    ...
    EMA9, IV, Gamma, Vega, Theta (per-day) and Theta (trailing 15-min).
    Returns None if CE/PE data could not be fetched. Shared by the live
    dashboard (main()) and the backtester so both stay in sync.
    """
