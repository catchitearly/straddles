...
os.makedirs("docs", exist_ok=True)  # For GitHub Pages
...
# Record run timestamp for auto-refresh
...
<body>
    ...
    // Optional: Add JavaScript-based auto-refresh (fallback)
    setTimeout(function() {{
        location.reload();
    }}, 300000); // 5 minutes
    </script>
...
def main():
    ...
    try:
        ...
        atm = 24400  # Update this dynamically if needed
        ...
        if results:
            ...
            dashboard_path = build_dashboard_html(results, atm, rankings)
