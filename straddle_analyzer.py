...
TARGET_DATE = os.getenv("TARGET_DATE") or "2026-07-10"  #datetime.now(ZoneInfo("Asia/Kolkata")).strftime("%Y-%m-%d")
...
def update_gex_and_get_history(fyers, fallback_spot):
    ...
    append to persisted history log. Returns full day's history so far.
    """
